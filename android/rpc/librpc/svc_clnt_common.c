                                 ...
                                 rpc_msg_e_type rpc_msg_type)
{
     ...
     * process accessing the same program, we serialize access in android_clnt_call()
     ...
     * the use of a mutex in android_clnt_call().
     * 
     * NOTE: This comment assumes that the only way we talk to the RPC router
     *       from a client is by using android_clnt_call(), which is the case for all
